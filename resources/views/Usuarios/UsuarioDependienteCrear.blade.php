...
@section('titulo', 'Crear Usuario Dependiente')
...
<div class="dashboard-main-body">
  <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">Crear Usuario Dependiente</h6>
    <ul class="d-flex align-items-center gap-2">
      ...
      <li>-</li>
      <li class="fw-medium">Crear Dependiente</li>
    </ul>
  </div>

  <div class="card h-100 p-0 radius-12">
    <div class="card-body">
      <form method="POST" action="{{ route('usuarios.dependientes.guardar') }}">
        @csrf
        ...
        <div class="row mb-3">
          <div class="col-12 col-md-4">
            ...
            <input type="text"
                   class="form-control radius-8 @error('nombre') is-invalid @enderror"
                   name="nombre"
          ...
          <div class="col-12 col-md-4">
            ...
            <input type="text"
                   class="form-control radius-8 @error('correo') is-invalid @enderror"
                   name="correo"
        ...
        <div class="row mb-4">
          <div class="col-12 col-md-10">
            <label for="public-methods" class="form-label fw-semibold text-primary-light fs-6 mb-3">
              Permisos para el usuario dependiente <span class="text-danger-600">*</span>
            </label>
      ...
      <div class="mt-16 text-muted" style="font-size: 12px;">
        * Este usuario dependiente usará la misma licencia del titular automáticamente.
      </div>
    </div>
  </div>
</div>
...
@section('scripts')
  ...
  <script>
    (function () {
      // Si existiera Select2 por ahí, lo destruimos (como haces tú)

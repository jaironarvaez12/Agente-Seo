...
@php
  ...
  $techSummary = data_get($techData, 'summary', []);
  ...
  $safeJson = function ($value, $maxChars = 12000) {
...
<div class="dashboard-main-body">
  <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <a href="{{ route('dominiosreportes', $dominio->id_dominio) }}" class="btn btn-secondary btn-sm">
        Ver Reportes Anteriores
      </a>

      <a href="{{ route('dominios.reporte_seo.pdf', $dominio->id_dominio) }}" class="btn btn-primary btn-sm">
        Descargar PDF
      </a>
    </div>
  </div>
    ...
    <div class="card radius-12 mb-16">
      <div class="card-body p-24">
        ...
        @else
          ...
          @else
            <div class="alert alert-info mb-0">
              Moz no devolvió métricas para estas keywords.
            </div>
          @endif
        @endif
      </div>

                            ...
                            <tr>
                                ...
                                <td class="text-center"> 
                                    <div class="d-flex align-items-center gap-10 justify-content-center">
                                        ...
                                        <a href="{{ route('backlinkcontenido', $perfil->id_dominio) }}" 
                                        ...
                                        <a href="{{ route('backlinksgenerados', $perfil->id_dominio) }}"
                                            title="Backlinks"
                                            class="btn btn-primary fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle p-0">
                                            <iconify-icon icon="mdi:link-variant" class="menu-icon text-white"></iconify-icon>
                                        </a>
